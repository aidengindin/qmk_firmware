...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = LAYOUT(
    ...
    _______, GUI_T(KC_A), ALT_T(KC_S), CTL_T(KC_D), SFT_T(KC_F),         KC_G,                                                 KC_H,              SFT_T(KC_J), CTL_T(KC_K), ALT_T(KC_L), GUI_T(KC_QUOT), _______,
    _______, KC_Z,        KC_X,        KC_C,        KC_V,                KC_B,             _______,          _______,          KC_N,              KC_M,        KC_COMM,     KC_DOT,      KC_SLSH,        _______,
                                                    LT(_MOUSE, KC_TAB), LT(_NUM, KC_BSPC), LT(_NAV, KC_DEL), LT(_FUN, KC_ENT), LT(_SYMB, KC_SPC), LT(_MEDIA, KC_ESC)
  ),

  [_NUM] = LAYOUT(
    _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
    _______, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                     KC_NO,   KC_7,    KC_8,   KC_9,     KC_GRV,  _______,
    _______, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_NO,                     KC_EQL,  KC_4,    KC_5,   KC_6,     KC_SCLN, _______,
    _______, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   _______, _______, KC_BSLS, KC_1,    KC_2,   KC_3,     KC_NO,   _______,
                                        KC_NO,   KC_NO,   KC_NO,   KC_MINS, KC_0,    KC_NO
  ),
};
